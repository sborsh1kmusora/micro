...
func (s *CreateOrderRequest) encodeFields(e *jx.Encoder) {
	...
	{
		e.FieldStart("item_uuids")
		e.ArrStart()
		for _, elem := range s.ItemUuids {
			e.Str(elem)
		}
		e.ArrEnd()
	}
		...
		case "item_uuids":
			...
			if err := func() error {
				...
				if err := d.Arr(func(d *jx.Decoder) error {
					...
					s.ItemUuids = append(s.ItemUuids, elem)
					return nil
				}); err != nil {
					return err
				}
				...
				return errors.Wrap(err, "decode field \"item_uuids\"")
			}
		default:
			return d.Skip()
		}
